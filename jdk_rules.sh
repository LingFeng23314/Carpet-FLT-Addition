...
RULES_JDK25="$3"    # JDK 25 规则（26.x 独立项目用）
RULES_JDK21="$4"    # JDK 21 规则
RULES_JDK17="$5"    # JDK 17 规则
RULES_JDK8="$6"     # JDK 8 规则
...
# **按照 JDK 25 → JDK 21 → JDK 17 → JDK 8 顺序匹配**（26.x 命中 25，1.x 按原有规则）
